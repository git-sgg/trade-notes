...
-- 盒马鲜生门店表
CREATE TABLE IF NOT EXISTS hema_stores (
    id VARCHAR(64) PRIMARY KEY,
    name VARCHAR(100) NOT NULL COMMENT '门店名称',
    address VARCHAR(255) COMMENT '门店地址',
    start_time_online VARCHAR(10) COMMENT '线上营业开始',
...
-- 山姆会员店门店表
CREATE TABLE IF NOT EXISTS sam_stores (
    id VARCHAR(64) PRIMARY KEY,
    name VARCHAR(100) NOT NULL COMMENT '门店名称',
    address VARCHAR(255) COMMENT '门店地址',
    start_time_online VARCHAR(10) COMMENT '线上营业开始',
    ...
    longitude DECIMAL(10, 7) COMMENT '经度',
    latitude DECIMAL(10, 7) COMMENT '纬度',
    status INT COMMENT '状态（0=营业中，1=筹建中）',
    created_time DATETIME,
    INDEX idx_longitude (longitude),
    INDEX idx_latitude (latitude)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS stores (
    id VARCHAR(64) PRIMARY KEY COMMENT '品牌前缀+原ID，如 seven_xxx, hema_001, sam_001',
